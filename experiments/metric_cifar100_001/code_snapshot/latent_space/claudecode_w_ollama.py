...
ASSISTANT_COLOR = "\u001b[93m"
RESET_COLOR = "\u001b[0m"
MODEL = "ministral-3:14b"  # qwen3-coder:30b | nemotron-3-nano:latest
...
Use compact single-line JOSN with double quotes. After receiving a tool_request(...) message, continue the task.
...
def extract_tool_invocations(text: str) -> list[tuple[str, dict[str, Any]]]:
    ...
    """
    invocations = []
    for raw_lines in text.splitlines():
...
"""
Make me a new file called hello.rs and implement hello world in it.
"""
