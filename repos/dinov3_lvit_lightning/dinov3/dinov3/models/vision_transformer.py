...
# Allow using the vendored DINOv3 code in `tmp/dinov3` without installing it.
_DINOV3_VENDOR_ROOT = os.path.join(os.path.dirname(__file__), "dinov3")
if _DINOV3_VENDOR_ROOT not in sys.path:
    sys.path.insert(0, _DINOV3_VENDOR_ROOT)
...
def vit_small(patch_size=16, embed_dim=384, depth=12, num_heads=6, ffn_ratio=4, **kwargs):
