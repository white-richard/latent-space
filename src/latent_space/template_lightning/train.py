...
from .datamodule import GenericLightningDataModule
...
def generate_visualizations(
    ...
    datamodule: GenericLightningDataModule,
...
def train(config: Config):
    ...
    datamodule = GenericLightningDataModule(config.data)
    datamodule.setup()
    num_train_batches = len(datamodule.train_dataloader())
    config.model.num_batches = num_train_batches
    config.training.num_batches = num_train_batches
